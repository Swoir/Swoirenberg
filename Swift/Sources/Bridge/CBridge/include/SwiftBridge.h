...
void* __swift_bridge__$prove_swift(void* circuit_bytecode, void* initial_witness);
struct __private__OptionBool __swift_bridge__$verify_swift(void* circuit_bytecode, void* proof, void* vkey);
